...
semanttista tai syntaktista rakennetta \cite{mikolov2013efficient}. Menetelmän etuna on yksikäsitteisyys ja
...
konteksteihin astuen esiin niin sanottuna "ulottuvuuksien kirouksena" (engl. \textit{curse of dimensionality}) \cite{bengio2003neural}. Tämän vuoksi on hyödyllistä tarkastella samaa ongelmaa
