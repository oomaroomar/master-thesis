...
\begin{align*}
  h^{(0)} &= x(c),\\
  a^{(\ell)} &= h^{(\ell-1)} W^{(\ell)} + b^{(\ell)},
  & \ell = 1,\dots,L, \\
  h^{(\ell)} &= \phi^{(\ell)}\!\left(a^{(\ell)}\right),
  & \ell = 1,\dots,L,
\end{align*}
missä \(W^{(\ell)}\in\mathbb{R}^{d_{\ell-1}\times d_\ell}\) on kerroksen
\(\ell\) painomatriisi, \(b^{(\ell)}\in\mathbb{R}^{1\times d_\ell}\) sen bias-rivivektori,
\(a^{(\ell)}\in\mathbb{R}^{1\times d_\ell}\) affiinisen muunnoksen tulos ja
\(h^{(\ell)}\in\mathbb{R}^{1\times d_\ell}\) kerroksen \(\ell\) piiloesitys rivivektorina.
...
\[
  z = h^{(L)} W^{(\mathrm{out})} + b^{(\mathrm{out})},
\]
missä \(W^{(\mathrm{out})}\in\mathbb{R}^{d_L\times |\mathcal{V}|}\),
\(b^{(\mathrm{out})}\in\mathbb{R}^{1\times |\mathcal{V}|}\) ja \(z\in\mathbb{R}^{1\times |\mathcal{V}|}\).
...
\[
  ...
  =
  \frac{\exp(z_j)}{\sum_{k=1}^{|\mathcal{V}|}\exp(z_k)},
