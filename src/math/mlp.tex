...
perseptronitutkimuksessa, erityisesti artikkelissa \emph{The Perceptron: A
Probabilistic Model for Information Storage and Organization in the Brain}
\cite{rosenblatt1958perceptron} sekä teoksessa \emph{Principles of
Neurodynamics: Perceptrons and the Theory of Brain Mechanisms}
\cite{rosenblatt1962principles}. Näissä töissä esitettiin varhaisia
...
Seymour Papertin teos \emph{Perceptrons: An Introduction to Computational
Geometry} \cite{minsky1969perceptrons}, jossa analysoitiin yksikerroksisten
perseptronien rajoitteita. Teos osoitti, että yksinkertainen perseptroni ei voi
...
lähtökohta syntyi Seppo Linnainmaan työssä \emph{The Representation of the
  Cumulative Rounding Error of an Algorithm as a Taylor Expansion of the Local
Rounding Errors} \cite{linnainmaa1970taylor}, jossa esitettiin käänteisen suunnan automaattinen derivointi menetelmä.
Paul Werbos puolestaan sovelsi tätä ajatusta neuroverkkoihin väitöskirjassaan
\emph{Beyond Regression: New Tools for Prediction and Analysis in the Behavioral
Sciences} \cite{werbos1974beyond} ja myöhemmin artikkelissaan
\emph{Backpropagation Through Time: What It Does and How to Do It}
\cite{werbos1990bptt}, jossa termi vastavirta-algoritmi (engl. \emph{backpropagation}) vakiintui.
...
Williams popularisoivat vastavirta-algoritmin artikkelissaan
\emph{Learning Representations by Back-Propagating Errors}
\cite{rumelhart1986learning}. Tämä työ teki MLP:stä käytännöllisen
gradienttipohjaisesti opetettavan funktionapproksimaattorin ja loi perustan
...
\section{Vastavirta-algoritmi}
\section{Attention-mekanismi}
