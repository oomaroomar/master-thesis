...
\(W = (w_1, w_2, \dots, w_{|W|})\), voidaan jokainen tokeni \(w_t \in \mathcal{V}\)
...
Olkoon korpus \(W = (w_1, w_2, \dots, w_{|W|})\), missä \(w_t \in \mathcal{V}\) on
...
{\sum_{w \in \mathcal{V}} \exp(u_w^{\top} v_{w_I})}.
$$
