\section{Gradienttimenetelmä}\label{sec:grad}
...
oppimisnopeuden suuruutta, koska liian suuri askel voi johtaa divergenssiin tai
...
Tämä voidaan tulkita diagonaalisena esiehdollistuksena.
...
Adam (\emph{adaptive moment estimation}) yhdistää gradientin ensimmäisen momentin eli suunnatun liukuvan keskiarvon sekä neliöityjen gradienttien toisen momentin eli liukuvan keskiarvon \cite{kingma2015adam}. Menetelmässä määritellään rekursiot
\begin{align*}
  m_t
  &=
