...
Dekooderilohko muuntaa tokenien esitysmatriisin uudeksi
samankokoiseksi esitysmatriisiksi. Kokonainen kielimalli muodostetaan
yhdistämällä tokenien upotus, useita peräkkäisiä dekooderilohkoja sekä
seuraavan tokenin jakauman tuottava tuloskerros.
...
ovat opittavia parametreja. Rivivektorin \(\ell_i\) komponentti
...
Position \(i\) tulos ennustaa seuraavaa tokenia \(w_{i+1}\):
$$
...
v_j \in \mathcal{V}.
$$
Koko syötekontekstia \(w_{1:T}\) seuraavan tokenin jakauma saadaan
viimeisen position tuloksesta:
$$
f_{\mathrm{Tr}}(w_{1:T})
=
