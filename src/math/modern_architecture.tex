...
kontekstin tokenien avainvektoreihin, ja vertailun perusteella lasketaan
painot arvovektoreille, joilla päivitetään tokenin esitystä.

Kyselyvektoria voidaan tulkita kuvauksena siitä, millaiseen kontekstissa esiintyvään informaatioon tokenin esitys kohdistuu. Avainvektoria voidaan vastaavasti tulkita kuvauksena informaatiosta, jonka perusteella muut tokenit voivat kohdistaa siihen huomiota. Arvovektori sisältää informaation, jota yhdistetään painotettuna uuden tokeniesityksen muodostamiseksi.
...
\end{align*}
Matriisin \(H\) kukin rivi sisältää siis yhden tokenin
...
\begin{align*}
  ...
  AV.
\end{align*}
Yksittäisen tokenin \(i\) kohdalla laskenta voidaan esittää muodossa
\begin{align*}
  o_i
  =
...
vastaava arvovektori. Tokenin \(i\) uusi esitys \(o_i\) muodostuu siis
...
antaa hyödyntää ennustettavaa tokenia eikä sen jälkeisiä tokeneita. Jos
koulutusvaiheessa tokenin \(x_t\) esitys voisi osallistua tokenin \(x_t\)
ennustamiseen, malli voisi ratkaista tehtävän käyttämällä tulevaa tietoa.
Tällaista tiedon vuotamista estetään kausaalisella huomiomaskilla.
