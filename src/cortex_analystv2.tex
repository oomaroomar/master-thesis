...
\section{Kokeet}
Ensimmäisessä kokeessa tarkastellaan Cortex Analystin konsistenssia, eli sitä, tuottaako järjestelmä saman SQL-kyselyn, kun sama luonnollisen kielen kysymys esitetään useita kertoja. Toisessa kokeessa tarkastellaan järjestelmän herkkyyttä sellaisille syötteen muutoksille, joiden ei pitäisi muuttaa kysymyksen merkitystä. Näissä kokeissa muodostetaan useita eri sanamuotoja samasta tiedontarpeesta ja arvioidaan, tuottaako järjestelmä niistä olennaisesti saman SQL-kyselyn.

Käytetyt kyselyt konsistenssikokeessa ovat seuraavat
\begin{enumerate}
  \item How many total contacts did we handle in January 2026?
  \item What's our answer rate for calls in February 2026?
  \item Give me the average queue duration for callbacks last month
  \item What was our service level percentage by queue in Q4 of 2025?
...
\end{enumerate} Herkkyyskokeessa käytetään samoja kyselyjä ja niistä muodostettuja vaihtoehtoisia muotoja.
