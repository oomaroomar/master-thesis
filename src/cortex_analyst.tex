...
\paragraph{Semanttinen näkymä} Jotta CA pystyy tekemään syntaktisesti valideja SQL kyselyitä, määritellään semanttinen näkymä, jossa taulut ja niiden kentät on kuvattu YAML formaattiin. Kun semanttinen näkymä lisätään kielimallin kontekstiin, niin kielimalli ymmärtää tietokannan rakenteen ja osaa muodostaa oikeanlaisia SQL kyselyitä. Semanttinen näkymä on esitetty kuvassa
\begin{figure}
  ...
  - name: CONV
    ...
    primary_key:
      columns:
        ...
        - IDENTIFIER
\end{lstlisting}
  \caption{Esimerkki semanttisesta näkymästä, joka kuvaa tietokannan rakennetta ja kenttien merkityksiä. }
