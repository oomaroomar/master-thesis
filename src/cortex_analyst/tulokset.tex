\section{Tulokset}\label{sec:results}
...
Kysymyksessä C ja sen variaatioissa puhutaan palvelutasosta, jolloin implisiittisenä taustaoletuksena on, että tarkastelu kohdistuu vain saapuviin kontakteihin. Havainto viittaa siihen, että Cortex Analyst ei tässä tutkimusasetelmassa aina huomioinut tällaisia implisiittisiä oletuksia johdonmukaisesti. Luonnollisen kielen kysymyksissä esiintyvät monitulkinnaiset ilmaukset ja implisiittisen toimialatiedon päättely muodostavatkin tunnetun haasteen Text-to-SQL-malleille \cite{deng2021spiderrealistic, chang2023drspider}.
...
On kuitenkin huomioitava, että juuri nämä sarakkeet nousivat esiin tässä tutkimusasetelmassa. Toisenlaisessa tietokannassa tai toisessa sovellusympäristössä ongelmalliset kentät voisivat olla erilaisia. Havainto korostaa semanttisen näkymän merkitystä järjestelmän luotettavuuden kannalta. Voidaan hypotetisoida, että semanttisen näkymän huolellinen suunnittelu, tietokannan metadatan rikastaminen sekä mallin iteratiivinen ohjaaminen voisivat parantaa suorituskykyä myös laajemmassa mittakaavassa \cite{CortexAnalyst, li2024bird}. Tämän hypoteesin varmentaminen vaatii kuitenkin lisätutkimusta laajemmilla aineistoilla.
